...
--
-- Host: localhost:3306
-- Generation Time: Oct 22, 2019 at 02:59 PM
...
CREATE TABLE `member_info` (
  `mbr_iid` int(11) NOT NULL,
  `mbr_name` varchar(100) NOT NULL,
  `mbr_father` varchar(100) NOT NULL,
  `mbr_mother` varchar(100) NOT NULL,
  `mbr_age` varchar(50) NOT NULL,
  `mbr_dob` varchar(100) NOT NULL,
  `mbr_nid_num` varchar(300) NOT NULL,
  `present_area` varchar(100) NOT NULL,
  `present_thana_id` int(100) NOT NULL,
  `present_dist_id` int(100) NOT NULL,
  `present_div_id` int(100) NOT NULL,
  `mbr_img` varchar(100) NOT NULL,
  `parmanent_area` varchar(100) NOT NULL,
  `parmanent_thana_id` int(100) NOT NULL,
  `parmanent_dist_id` int(100) NOT NULL,
  `parmanent_div_id` int(100) NOT NULL,
  `add_date` varchar(100) NOT NULL,
  `this_time` varchar(100) NOT NULL,
  `m_pay` int(50) NOT NULL,
  `mbr_occupation` varchar(100) NOT NULL,
  `mbr_wife_hus_name` varchar(100) NOT NULL,
  `mbr_mobile` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `member_info` (`mbr_iid`, `mbr_name`, `mbr_father`, `mbr_mother`, `mbr_age`, `mbr_dob`, `mbr_nid_num`, `present_area`, `present_thana_id`, `present_dist_id`, `present_div_id`, `mbr_img`, `parmanent_area`, `parmanent_thana_id`, `parmanent_dist_id`, `parmanent_div_id`, `add_date`, `this_time`, `m_pay`, `mbr_occupation`, `mbr_wife_hus_name`, `mbr_mobile`) VALUES
(2, 'Abu Nayem', 'Abul Kashem', 'Amena Khatun', '29', '1991-07-01', '199911151151425115542', 'Sona Pahar, Zorargonj', 75, 43, 2, 'upload/member/Web_Page_Pic_01.jpg', 'Same', 75, 43, 2, '2019-10-22', '1571754618', 0, 'Service Holder', 'UUUUUUUUUUUUU', '01819084855');
...
CREATE TABLE `nomini_info` (
  `n_iid` int(11) NOT NULL,
  `n_name` varchar(100) NOT NULL,
  `n_father` varchar(100) NOT NULL,
  `n_mother` varchar(100) NOT NULL,
  `n_hus_wife` varchar(100) NOT NULL,
  `mbr_relation` varchar(100) NOT NULL,
  `n_img` varchar(100) NOT NULL,
  `n_prs_area` varchar(100) NOT NULL,
  `n_prs_thana_iid` varchar(50) NOT NULL,
  `n_prs_dist_iid` varchar(50) NOT NULL,
  `n_prs_div_iid` varchar(50) NOT NULL,
  `n_prm_area` varchar(100) NOT NULL,
  `n_prm_thana_iid` varchar(50) NOT NULL,
  `n_prm_dist_iid` varchar(50) NOT NULL,
  `n_prm_div_iid` varchar(50) NOT NULL,
  `this_time` varchar(100) NOT NULL,
  `mbr_iid` int(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `settings` (
  `st_idi` int(11) NOT NULL,
  `sys_name` varchar(100) NOT NULL,
  `sys_title` longtext NOT NULL,
...
INSERT INTO `settings` (`st_idi`, `sys_name`, `sys_title`, `sys_logo`, `month_fee`) VALUES
(1, 'নাঈম বাবু সমবায় সমিতি', 'সঞ্চয় করুন আপনার পরবর্তী প্রজন্মের জন্য', 'upload/set_img/favicon.ico', '1000');
...
INSERT INTO `users` (`id`, `ip_address`, `username`, `password`, `email`, `activation_selector`, `activation_code`, `forgotten_password_selector`, `forgotten_password_code`, `forgotten_password_time`, `remember_selector`, `remember_code`, `created_on`, `last_login`, `active`, `first_name`, `last_name`, `company`, `phone`, `mbr_iid`) VALUES
(1, '127.0.0.1', 'admin', '$2y$12$GH3uwQikxPaQywcPafDr/e9GcmkfZkIbjYGvofYBRQn9nOOQ0Ozge', 'admin@admin.com', NULL, '', NULL, NULL, NULL, NULL, NULL, 1268889823, 1571752573, 1, 'Admin', 'istrator', 'ADMIN', '0', 2);
...
--
ALTER TABLE `member_info`
  MODIFY `mbr_iid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `nomini_info`
--
ALTER TABLE `nomini_info`
  MODIFY `n_iid` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `settings`
--
ALTER TABLE `settings`
  MODIFY `st_idi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `districts`
  ADD CONSTRAINT `districts_ibfk_1` FOREIGN KEY (`division_id`) REFERENCES `divisions` (`div_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `unions`
--
ALTER TABLE `unions`
  ADD CONSTRAINT `unions_ibfk_1` FOREIGN KEY (`upazila_id`) REFERENCES `upazilas` (`up_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `upazilas`
--
ALTER TABLE `upazilas`
  ADD CONSTRAINT `upazilas_ibfk_1` FOREIGN KEY (`district_id`) REFERENCES `districts` (`dis_id`) ON DELETE CASCADE ON UPDATE CASCADE;
